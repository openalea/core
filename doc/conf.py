...
sys.path.insert(0, os.path.abspath('../src')) # to include the root of the package
...
htmlhelp_basename = 'core_documentation'
...
texinfo_documents = [
    (master_doc, 'core', u'core Documentation',
     author, 'core', 'OpenAlea.Core is able to discover and manage packages and logical components, build and evaluate dataflows and generate final applications',
     'Miscellaneous'),
]
