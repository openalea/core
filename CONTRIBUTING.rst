...
1. Fork the `core` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/core.git
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/openalea/core/pull_requests
...
.. _issues: https://github.com/openalea/core/issues
